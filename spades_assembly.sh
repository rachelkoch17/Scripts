...
bbmerge.sh in1=${filename1}_R1.fastq.gz in2=${filename1}_R2.fastq.gz outa=adapters.fa 

bbduk.sh in1=${filename1}_R1.fastq.gz in2=${filename1}_R2.fastq.gz out1=${filename1}_R1_clean.fq.gz out2=${filename1}_R2_clean.fq.gz outs=${filename1}_singletons.fq.gz ref=adapters.fa ktrim=r k=21 mink=11 hdist=1 tpe tbo
